...
# rend = cackle.CackleRenderer(1920, 1080, 240, 135)
...
rend.setCameraRight( 0.70, 0.00, -0.70 )
# rend.setCameraFOV(	 97.5)
rend.setCameraFOV(	 85.0)
...
rend.render()
rend.outputImage("/DPA/wookie/zshore/fractals/posters/src/mandelbox_uhd_test.0001.exr")
